...
<div class="quiz-container">
    <div class="quiz-question">1. Which pattern is better suited for creating a "family" of related objects?</div>
...
<div class="quiz-container">
    <div class="quiz-question">2. How does the Factory Method pattern utilize polymorphism?</div>
    <ul class="quiz-options">
...
<div class="quiz-container">
    <div class="quiz-question">3. In the Abstract Factory pattern, if you need to add a new product type (e.g., "RadioButton") to the family, what changes are required?</div>
    <ul class="quiz-options">
...
<div class="quiz-container">
    <div class="quiz-question">4. True/False: The Factory Method pattern relies more on inheritance than composition.</div>
    <ul class="quiz-options">
...
<div class="quiz-container">
    <div class="quiz-question">5. What is a primary difference between the Factory Method and the Abstract Factory pattern?</div>
    <ul class="quiz-options">
