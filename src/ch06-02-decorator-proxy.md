...
1. Which pattern is used to implement "Lazy Loading"?
2. What is the main problem with using inheritance instead of the Decorator pattern for adding features?
3. How does a Protection Proxy differ from a Virtual Proxy?
4. True/False: In the Decorator pattern, the decorator and the object it decorates must implement the same interface.

---
### Module Quiz

<div class="quiz-container">
    <div class="quiz-question">Which pattern is specifically used to control access to an object, such as implementing permissions or lazy loading?</div>
    <ul class="quiz-options">
        <li class="quiz-option"><input type="radio" name="q06_02" id="q06_02_a" data-correct="false"><label for="q06_02_a">Decorator</label></li>
        <li class="quiz-option"><input type="radio" name="q06_02" id="q06_02_b" data-correct="true"><label for="q06_02_b">Proxy</label></li>
        <li class="quiz-option"><input type="radio" name="q06_02" id="q06_02_c" data-correct="false"><label for="q06_02_c">Composite</label></li>
    </ul>
