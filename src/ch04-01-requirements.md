...
<div class="quiz-container">
    <div class="quiz-question-wrapper">
        <div class="quiz-question">1. "The system should be able to handle 10,000 concurrent requests" is an example of: <span class="quiz-feedback-inline"></span></div>
    ...
    <div class="quiz-question-wrapper">
        <div class="quiz-question">2. Why is it important to define "Out-of-Scope" features? <span class="quiz-feedback-inline"></span></div>
        <ul class="quiz-options">
    ...
    <div class="quiz-question-wrapper">
        <div class="quiz-question">3. What is a "Functional Requirement" for an ATM? <span class="quiz-feedback-inline"></span></div>
        <ul class="quiz-options">
