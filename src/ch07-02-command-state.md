...
<div class="quiz-container">
    <div class="quiz-question-wrapper">
        <div class="quiz-question">1. How does the Command pattern support "Undo" functionality?</div>
    ...
    <div class="quiz-question-wrapper">
        <div class="quiz-question">2. In the State pattern, who is responsible for the transition between states?</div>
        <ul class="quiz-options">
    ...
    <div class="quiz-question-wrapper">
        <div class="quiz-question">3. What is the main difference between the Strategy pattern and the State pattern?</div>
        <ul class="quiz-options">
    ...
    <div class="quiz-question-wrapper">
        <div class="quiz-question">4. True/False: The Command pattern requires the sender to know the specific class of the receiver.</div>
        <ul class="quiz-options">
    ...
    <div class="quiz-question-wrapper">
        <div class="quiz-question">5. Which pattern allows an object to alter its behavior when its internal state changes, making it appear as if it changed its class?</div>
        <ul class="quiz-options">
