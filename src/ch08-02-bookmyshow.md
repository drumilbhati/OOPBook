...
<div class="quiz-container">
    <div class="quiz-question-wrapper">
        <div class="quiz-question">1. What is the best way to handle "temporary" locks (seats held for 10 mins during payment)? <span class="quiz-feedback-inline"></span></div>
    ...
    <div class="quiz-question-wrapper">
        <div class="quiz-question">2. To improve search performance for movies in a specific city, which technique is most effective? <span class="quiz-feedback-inline"></span></div>
        <ul class="quiz-options">
    ...
    <div class="quiz-question-wrapper">
        <div class="quiz-question">3. In a distributed environment, why is `synchronized` keyword in Java insufficient for seat booking? <span class="quiz-feedback-inline"></span></div>
        <ul class="quiz-options">
